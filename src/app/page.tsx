...
export default function HomePage() {
  return <main>
    ...
    <section className="hero"><div className="page-width hero-inner"><div className="hero-copy"><span className="eyebrow"><CloudSnow size={15} /> Snow-first forecasting</span><h1>Know where the snow is coming.</h1><p>Search a real U.S. location and get a snow-first forecast built from authoritative weather data, with freshness, confidence, and source context visible.</p><SearchBox /></div><div className="hero-side"><div className="terrain-art"><div className="mountain mountain-a" /><div className="mountain mountain-b" /><div className="mountain mountain-c" /><div className="art-label"><span>REAL DATA</span><strong>Forecasts, not demos.</strong></div></div></div></div></section>
